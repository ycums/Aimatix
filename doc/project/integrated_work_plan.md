...
- [ ] 2.1: test/pure/配下のロジック（TimeLogic, AlarmLogic, ButtonManager等）をmain.cppや状態遷移システムと実際に接続・統合
- [ ] 2.2: DI/アダプター層で物理層と純粋ロジック層をIButtonManager等で抽象化・接続
- [ ] 2.3: 状態遷移システム・UIでIButtonManager等の抽象型を利用
- [ ] 2.4: 統合テスト・結合テスト追加、API設計の有用性・問題点を実証的に検証
- [ ] 2.5: 統合・運用結果をもとにAPI設計や責務分離の見直し・改善
